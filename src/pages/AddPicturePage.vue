<template>
  <div id="addPicturePage">
    ...
    >
      ...
      <a-form-item>
        <a-button type="primary" html-type="submit" style="width: 100%">创建图片</a-button>
      </a-form-item>
    </a-form>
  </div>
</template>
...
const handleSubmit = async (values: any) => {
  const pictureId = pictureForm.id
...
const getTagCategoryOption = async () => {
...
onMounted(() => {
  getTagCategoryOption()
})

const route = useRoute()

// 获取老数据
const getOldPictureOption = async () => {
  // 获取到id
