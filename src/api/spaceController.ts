...
/** 编辑空间（给用户使用） POST /api/space/edit */
...
/** 根据 id 获取空间（仅管理员可用） GET /api/space/get */
...
/** 获取空间级别列表，便于前端展示 GET /api/space/list/level */
...
/** 分页获取空间列表（仅管理员可用） POST /api/space/list/page */
...
/** 更新空间（仅管理员可用） POST /api/space/update */
